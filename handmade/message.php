...
<?php } ?>
            <form action="?do=sendMessage" method="POST"style="text-align: right;padding-right: 130pt;padding-left: 130pt;width: auto;">
              <label style="color: #000"> <?php echo  $message['UserCust'];   ?>  المرسل إليه </label>
...
$recepionId="1";
            ...
            <form action="?do=sendAdmin" method="POST"style="text-align: right;padding-right: 30pt;padding-left: 30pt;width: auto;">
